...
var AuthService = (function () {
    ...
    AuthService.prototype.signUp = function (user) {
        ...
        var response = this.http.post(this.authUrl, user, this.headers)
...
AuthService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2_app_errors_errors_service__["a" /* ErrorsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_app_errors_errors_service__["a" /* ErrorsService */]) === "function" && _b || Object])
], AuthService);
...
var QaPairsService = (function () {
    ...
    QaPairsService.prototype.getQAPairs = function () {
        var _this = this;
        var jwt = localStorage.getItem('jwt') ? "?jwt=" + localStorage.getItem('jwt') : '';
    ...
    QaPairsService.prototype.isCorrectAnswer = function (id, answer) {
        var _this = this;
        var jwt = localStorage.getItem('jwt') ? "?jwt=" + localStorage.getItem('jwt') : '';
        return this.http.post(this.qapairsUrl + "/is_correct" + jwt, { id: id, answer: answer }, this.headers)
            .map(function (response) {
